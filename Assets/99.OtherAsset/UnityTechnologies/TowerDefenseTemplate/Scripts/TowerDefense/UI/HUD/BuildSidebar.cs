...
namespace TowerDefense.UI.HUD
{
	...
	public class BuildSidebar : MonoBehaviour
	{
		...
		protected virtual void Start()
		{
			...
			foreach (TowerDefense.Towers.Tower tower in LevelManager.instance.towerLibrary)
			{
		...
		void OnButtonTapped(TowerDefense.Towers.Tower towerData)
		{
		...
		/// </summary>
		/// <param name="towerData"></param>
		void OnButtonDraggedOff(TowerDefense.Towers.Tower towerData)
		{

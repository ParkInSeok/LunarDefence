...
namespace TowerDefense.UI.HUD
{
	...
	public class TowerSpawnButton : MonoBehaviour, IDragHandler
	{
		...
		/// </summary>
		public event Action<TowerDefense.Towers.Tower> buttonTapped;

		/// <summary>
		/// Fires when the pointer is outside of the button bounds
		/// and still down
		/// </summary>
		public event Action<TowerDefense.Towers.Tower> draggedOff;

		/// <summary>
		/// The tower controller that defines the button
		/// </summary>
		TowerDefense.Towers.Tower m_Tower;
		...
		/// </param>
		public void InitializeButton(TowerDefense.Towers.Tower towerData)
		{
			m_Tower = towerData;

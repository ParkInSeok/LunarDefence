...
namespace TowerDefense.UI.HUD
{
	...
	public class GameUI : Core.Utilities.Singleton<GameUI>
	{
		/// <summary>
		...
		/// </summary>
		public event Action<TowerDefense.Towers.Tower> selectionChanged;
		...
		/// </summary>
		public TowerDefense.Towers.Tower currentSelectedTower { get; private set; }
		...
		/// </exception>
		public void SetToDragMode([NotNull] TowerDefense.Towers.Tower towerToBuild)
		{
		...
		/// </exception>
		public void SetToBuildMode([NotNull] TowerDefense.Towers.Tower towerToBuild)
		{
			if (state != State.Normal)
			{
		...
		/// </summary>
		public void SetupRadiusVisualizer(TowerDefense.Towers.Tower tower, Transform ghost = null)
		{
		...
		/// </exception>
		public void SelectTower(TowerDefense.Towers.Tower tower)
		{
			if (state != State.Normal)
			{
		...
		public void PlaceTower()
		{
			...
			TowerDefense.Towers.Tower createdTower = Instantiate(m_CurrentTower.controller);
		...
		public void TrySelectTower(PointerInfo info)
		{
			...
			var controller = output.collider.GetComponent<TowerDefense.Towers.Tower>();
			if (controller != null)
			{
		...
		protected void PlaceGhost(UIPointer pointer)
		{
			...
			if (m_CurrentArea != null)
			{
				...
				{
					// Place the ghost
					TowerDefense.Towers.Tower controller = m_CurrentTower.controller;
		...
		/// </exception>
		void SetUpGhostTower([NotNull] TowerDefense.Towers.Tower towerToBuild)
		{

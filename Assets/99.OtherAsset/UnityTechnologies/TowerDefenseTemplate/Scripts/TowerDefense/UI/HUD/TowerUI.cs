...
namespace TowerDefense.UI.HUD
{
	...
	public class TowerUI : MonoBehaviour
	{
		...
		/// </summary>
		protected TowerDefense.Towers.Tower m_Tower;
		...
		/// </param>
		public virtual void Show(TowerDefense.Towers.Tower towerToShow)
		{
			if (towerToShow == null)
			{
				return;
		...
		protected virtual void OnUISelectionChanged(TowerDefense.Towers.Tower newTower)
		{
			if (newTower != null)
			{
				Show(newTower);

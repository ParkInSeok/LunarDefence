...
namespace TowerDefense.Agents
{
	...
	public class AttackingAgent : Agent
	{
		...
		/// Tower to target
		/// </summary>
		protected TowerDefense.Towers.Tower m_TargetTower;
		...
		protected TowerDefense.Towers.Tower GetClosestTower()
		{
			var towerController = m_AttackAffector.towerTargetter.GetTarget() as TowerDefense.Towers.Tower;
		...
		protected override void OnPartialPathUpdate()
		{
			...
			TowerDefense.Towers.Tower tower = GetClosestTower();

		...
		protected override void Update()
		{
			...
			if (LevelManager.instanceExists)
			{
				...
				for (var key = KeyCode.Alpha1; key < highestKey; key++)
				{
					...
					{
						TowerDefense.Towers.Tower controller = LevelManager.instance.towerLibrary[key - KeyCode.Alpha1];
				...
				{
					TowerDefense.Towers.Tower controller = LevelManager.instance.towerLibrary[9];
					GameUI.instance.SetToBuildMode(controller);
					GameUI.instance.TryMoveGhost(InputController.instance.basicMouseInfo);
				}
			}
